...
export declare abstract class AbstractService<T extends Document> {
    ...
    private parseSearchField;
    private createSearchCondition;
    findManyAndPaginate(queryFilter?: FilterQuery<T>, queryConfig?: QueryDataConfigInput): Promise<{
        results: T[];
    ...
    addToSetByFilter<M>(filter: FilterQuery<T>, arrayField: string, payload: any): Promise<boolean>;
