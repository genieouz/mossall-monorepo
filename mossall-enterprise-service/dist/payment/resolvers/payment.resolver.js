...
const payment_entity_1 = require("../dto/payment.entity");
...
__decorate([
    (0, graphql_1.Query)(returns => [payment_entity_1.Payment]),
...
__decorate([
    (0, graphql_1.Query)(returns => payment_entity_1.Payment),
    __param(0, (0, graphql_1.Args)({ name: 'paymentId', type: () => graphql_2.ID })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], PaymentResolver.prototype, "fetchPayment", null);
