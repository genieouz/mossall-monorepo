...
const collaborators_resolver_1 = require("./resolvers/collaborators.resolver");
...
CollaboratorsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [],
        providers: [collaborators_service_1.CollaboratorsService, collaborators_resolver_1.CollaboratorResolver],
