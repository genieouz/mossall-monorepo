...
exports.PaginatedUserResult = exports.User = void 0;
...
const state_interface_1 = require("../../commons/interfaces/state.interface");
...
exports.User = User;
let PaginatedUserResult = class PaginatedUserResult extends (0, pagination_1.PaginatedResult)(User) {
};
PaginatedUserResult = __decorate([
    (0, graphql_1.ObjectType)()
], PaginatedUserResult);
exports.PaginatedUserResult = PaginatedUserResult;
