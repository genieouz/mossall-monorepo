...
const finalize_forgot_password_input_1 = require("./dto/finalize-forgot-password.input");
...
let AuthResolver = class AuthResolver {
    ...
    async loginAdmin(loginInput) {
        return this.authService.loginJWT(loginInput);
    }
    async resetAdminPassword(resetPassword) {
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)({
        ...
        type: () => finalize_forgot_password_input_1.FinalizeForgotPasswordInput,
    })),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [finalize_forgot_password_input_1.FinalizeForgotPasswordInput]),
    __metadata("design:returntype", Promise)
], AuthResolver.prototype, "finalizeForgotPassword", null);
