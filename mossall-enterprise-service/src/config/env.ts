...
export const KEYCLOAK_ENTERPRISE_CLIENT_ID=process.env.KEYCLOAK_ENTERPRISE_CLIENT_ID
export const KEYCLOAK_ENTERPRISE_CLIENT_SECRET=process.env.KEYCLOAK_ENTERPRISE_CLIENT_SECRET
export const KEYCLOAK_COLLABORATOR_REALM=process.env.KEYCLOAK_COLLABORATOR_REALM
export const KEYCLOAK_COLLABORATOR_CLIENT_ID=process.env.KEYCLOAK_COLLABORATOR_CLIENT_ID
export const KEYCLOAK_COLLABORATOR_CLIENT_SECRET=process.env.KEYCLOAK_COLLABORATOR_CLIENT_SECRET

export const KEYCLOAK_MASTER_REALM=process.env.KEYCLOAK_MASTER_REALM
export const KEYCLOAK_MASTER_CLIENT_SECRET=process.env.KEYCLOAK_MASTER_CLIENT_SECRET;
...
export const COLLABORATOR_SERVICE_URL = process.env.COLLABORATOR_SERVICE_URL;
