...
const activity_input_1 = require("../dto/activity.input");
const activity_update_input_1 = require("../dto/activity.update.input");
...
let ActivityResolver = class ActivityResolver {
    ...
    updateActivity(activityInput, activityId) {
...
__decorate([
    (0, graphql_1.Mutation)(returns => activity_entity_1.Activity),
    __param(0, (0, graphql_1.Args)({ name: 'activityInput', type: () => activity_input_1.ActivityInput })),
...
__decorate([
    ...
    __param(0, (0, graphql_1.Args)({ name: 'activityInput', type: () => activity_update_input_1.ActivityUpdateInput })),
    __param(1, (0, graphql_1.Args)({ name: 'activityId', type: () => graphql_2.ID })),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], ActivityResolver.prototype, "fetchActivities", null);
__decorate([
    (0, graphql_1.Query)(returns => activity_entity_1.Activity),
