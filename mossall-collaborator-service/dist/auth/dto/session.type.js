...
__decorate([
    (0, graphql_1.Field)((type) => user_entity_1.User, {
        nullable: true,
        description: 'Null if user must reset his password',
    }),
...
__decorate([
    (0, graphql_1.Field)({
        nullable: true,
        description: 'Not null if user must reset his password. Null other cases',
    }),
...
], Session.prototype, "expires_in", void 0);
__decorate([
    (0, graphql_1.Field)({
        nullable: true,
        description: 'Not null if user must reset his password. Null other cases',
